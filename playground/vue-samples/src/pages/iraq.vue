...
function addRandomMarker() {
  // Iraq boundaries: approximately 29°N to 38°N and 39°E to 49°E
  const lat = 29 + Math.random() * 9 // 29°N to 38°N
  const lng = 39 + Math.random() * 10 // 39°E to 49°E
  const marker = {
    name: `Iraqi Marker ${(options.markers?.length ?? 0) + 1}`,
...
<template>
  <div class="container">
    <h1>ts-maps Vue Example - Iraq Map</h1>
