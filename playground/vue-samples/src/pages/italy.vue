...
function addRandomMarker() {
  // Italy boundaries: approximately 35°N to 47°N and 6°E to 18°E
  const lat = 35 + Math.random() * 12 // 35°N to 47°N
  const lng = 6 + Math.random() * 12 // 6°E to 18°E
  const marker = {
    name: `Italian Marker ${(options.markers?.length ?? 0) + 1}`,
...
<template>
  <div class="container">
    <h1>ts-maps Vue Example - Italy Map</h1>
