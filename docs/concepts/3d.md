...
point you grabbed under the pointer, and the horizon stays where it is. Tiles
are loaded for the ground the view actually sees, which reaches further than
the view's own rectangle once it is rotated or tilted.
